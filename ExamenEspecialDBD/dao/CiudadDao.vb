...
Public Class CiudadDao
    ...
    Public Function AgregarRegistro(ByVal ciudad As CiudadEntity) As Boolean
        ...
        Try
            Dim tsql As String = "Insert into Ciudades(nombreCiudad) values(@nombre)"
    ...
    Public Function EditarRegistro(ByVal ciudad As CiudadEntity) As Boolean
        Dim resp As Boolean = False
        Try
            Dim tsql As String = "update Ciudades set nombreCiudad = @nombre, estado = @estado where idCiudad = @id"
            Dim conn As New SqlConnection(strConn)
            conn.Open()
    ...
    Public Function EliminarRegistro(ByVal id As Integer) As Boolean
        Dim resp As Boolean = False
        Try
            Dim tsql As String = "delete from Ciudades where idCiudad = @id"
            Dim conn As New SqlConnection(strConn)
            conn.Open()
            Dim cmd As New SqlCommand(tsql, conn)
            cmd.CommandType = CommandType.Text
    ...
    Public Function MostrarRegistros() As DataSet
        ...
        Try
            Dim tsql As String = "select * from Ciudades"
            Dim conn As New SqlConnection(strConn)
    ...
    Public Function BuscarRegistro(ByVal id As Integer) As CiudadEntity
        ...
        Try
            Dim tsql As String = "select * from Ciudades where idCiudad = @id"
            Dim conn As New SqlConnection(strConn)
