Public Class FrmCiudad
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        ...
        If (resp) Then
            MsgBox("Regitro guardado satisfactoriamente", MsgBoxStyle.Information, "Registros MUSEO")
        Else
            MsgBox("Error al guardar registro.", MsgBoxStyle.Critical, "Moniores MUSEO")
        End If
        TbNombre.Clear()
        MostrarRegistros()
    End Sub
    ...
    Private Sub BtnEditar_Click(sender As Object, e As EventArgs) Handles BtnEditar.Click
        ...
        If (resp) Then
            MsgBox("Regitro editado satisfactoriamente", MsgBoxStyle.Information, "Registros MUSEO")
        Else
            MsgBox("Error al editar registro.", MsgBoxStyle.Critical, "Registros MUSEO")
        End If
        MostrarRegistros()
    End Sub
    ...
    Private Sub BtnEliminar_Click(sender As Object, e As EventArgs) Handles BtnEliminar.Click
        ...
        If (ciudad.Id = 0) Then
            MsgBox("Registro no existe.", MsgBoxStyle.Exclamation, "Registros MUSEO")
            Exit Sub
        End If
        Dim resp As VariantType
        resp = (MsgBox("¿Desea eliminar este registro " & ciudad.Id, MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Registros MUSEO"))
        If (resp = vbNo) Then
            MsgBox("Operación cancelada", MsgBoxStyle.Information, "Registros MUSEO")
            Exit Sub
        End If

        Dim eliminado = ciudadDao.EliminarRegistro(ciudad.Id)
        If (eliminado) Then
            MsgBox("Regitro eliminado satisfactoriamente", MsgBoxStyle.Information, "Registros MUSEO")
        Else
            MsgBox("Error al eliminar registro.", MsgBoxStyle.Critical, "Moniores MUSEO")
        End If
        MostrarRegistros()
    End Sub
